...
We explored various ways of training a linear probe, 
...
\paragraph{Results.}
We compare \chonk to the ViT-L of DeiT-III~\citep{touvron2022deit} and ViT-G of \citet{zhai2022scaling}, when only a fraction of the ADE20k semantic segmentation data is available. 
...
\begin{tabular}{@{} ll ccccc  @{}}
  ...
  \midrule
  \multirow[c]{3}{*}{\rotatebox{90}{DPT}} & ViT-L & 0.027 & 0.121 & 0.594 & 0.871 & 0.972 \\ 
  & ViT-e & 0.024 & 0.112 & 0.631 & 0.888 & 0.975 \\ 
  & \chonk & \textbf{0.021} & \textbf{0.095} & \textbf{0.702} & \textbf{0.909} & \textbf{0.979} \\ 
  \midrule
  \multirow[c]{3}{*}{\rotatebox{90}{Linear}} & ViT-L & 0.060 & 0.222 & 0.304 & 0.652 & 0.926 \\ 
  & ViT-e & 0.053 & 0.204 & 0.332 & 0.687 & 0.938 \\ 
  & \chonk & \textbf{0.039} & \textbf{0.166} & \textbf{0.412} & \textbf{0.779} & \textbf{0.960} \\ 
  \bottomrule
\end{tabular}
}
...
\vspace{0.05in}
Software: JAX~\citep{jax2018github}, Flax~\citep{flax2020github}, Scenic~\citep{dehghani2021scenic}.    
\\ \midrule
\multicolumn{1}{l|}{
\begin{minipage}{0.2\textwidth}
...
\begin{figure}[h]
    ...
    \subfigure[Input frame]{\includegraphics[width=0.15\textwidth]{figs/depth_prediction/DPT-1-ViT-22b-48459029-2/3_video.png}} \
