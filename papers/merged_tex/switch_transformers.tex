...
\begin{tabular}{ccccc}
    ...
    Switch-Base & 1.0 & -1.561 & \textbf{62.8} & 1000 \\ 
...
\centering
    ...
    \toprule
        ...
        Switch-Base (bfloat16) & -3.780 \rlap{[\emph{diverged}]}  & \textbf{1390} \\ 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.65\columnwidth]{images/perp_vs_speed.pdf} 
