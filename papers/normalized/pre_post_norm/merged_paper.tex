...
\printAffiliationsAndNotice{\textsuperscript{*}Equal contribution \textsuperscript{\dag}Works done while interning at Microsoft Research Asia} 
...
\begin{definition}
A random variable $Z\geq 0$ is called $(\epsilon,\delta)$-bounded if with probability at least $1-\delta$, $\frac{Z-\mathbb{E}Z}{\mathbb{E}Z}\leq \epsilon$, where $\epsilon>0$ and $0<\delta<1$. 
\end{definition}
