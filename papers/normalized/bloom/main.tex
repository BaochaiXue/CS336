...
\input{tables/linguistic_makeup_table.tex}
...
%\input{tables/MT-WMT-old}
\input{tables/MT-WMT-current}

\subsubsection{DiaBLa}

%\input{tables/MT-diabla-old}
\input{tables/MT-diabla-current}
...
%\input{tables/MT-flores-old}
\input{tables/MT-flores-current}
