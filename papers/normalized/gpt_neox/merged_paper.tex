...
where $R^d_{\Theta,x}$ is a $d\times d$ block diagonal matrix with the block of index $i$ being a $2$D rotation by $x\theta_i$ for hyperparameters $\Theta = \{\theta_i = 10000^{-2i/d}\;\vert\;i\in\{0,1,2,\ldots, (d-1)/2\}\}$. 
...
\begin{figure*}[hbt]
    \centering
    \input{Figures/training_node.tikz}
