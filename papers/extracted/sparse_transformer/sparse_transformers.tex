...
\includegraphics[width=0.95\textwidth]{learned_attn_masks_small.png}
...
\begin{figure*}
\centering     %%% not \center
\subfigure[\small{Transformer}]{\label{patt:a}\includegraphics[width=45mm]{attn-new-1.pdf}} \qquad \qquad
...
% \setlength\fboxsep{0pt}
% \setlength\fboxrule{0.25pt}
% \includegraphics[width=1.0\textwidth]{paper.png}

% \caption{Separable attention patterns for GemNets. Best viewed in color.}
% \label{f7}
% \end{figure*}
...
% \subsection{Separable Self-Attention}
...
\end{equation}
% \begin{equation} = \mathbf{e} \end{equation}
